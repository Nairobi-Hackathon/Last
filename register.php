...
if(isset($_POST['submit'])){
    ...
    try{
            $sql = "INSERT INTO users (First_Name, Last_Name, Org_Name, Enrollment, Email, Phone, Pass)
            VALUES('$f_name', '$l_name', '$org_name', '$enrollment', '$email', '$phone', '$pass')";
...
let form = document.getElementById('regform');
  ...
  form.addEventListener('submit', (e)=>{
    ...
    let done = document.getElementById('done').style.display = 'block';
...
<div class='alert alert-success' role='alert' id="done" style="display: none;">
    Registered Successfully!
</div></br>
...
<div class="registration-container">
    ...
    <form id="registrationForm" action="register.php" method="POST">
        ...
        <div class="form-section" id="step2">
            <div class="mb-3">
                <label for="regNumber" class="form-label">Name of the Organization</label>
                <input type="text" class="form-control" id="regNumber" name='org_name' required>
                <div class="invalid-feedback">Please enter your Organization name.</div>
            </div>
            <div class="mb-3">
                <label for="course" class="form-label">Number of Employees</label>
                <input type="number" class="form-control" id="course" name='enrollment' required>
                <div class="invalid-feedback">Please enter your Employees number.</div>
            </div>
    ...
    <!-- Step 3 -->
        ...
        <div class="form-section" id="step4">
            ...
            <button type="button" class="btn btn-secondary mb-3" onclick="prevStep()">Previous</button>
            <button class="btn submit btn-primary" name="submit" type="submit">Register</button>
        </div>
